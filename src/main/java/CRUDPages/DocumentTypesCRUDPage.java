...
public class DocumentTypesCRUDPage extends PageBase {

	public DocumentTypesCRUDPage(WebDriver driver1) {
		super(driver1);
		driver11 = driver1;
	}
	...
	@FindBy(id="DT_NAME") WebElement nameTxt;
...

	{
		...
		JSONArray jsonObjects = JsonDataReaderOnPage.ReadFromJsonDocumentTypes(moduleID);
