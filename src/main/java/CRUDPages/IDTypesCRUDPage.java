...
public class IDTypesCRUDPage extends PageBase {

	public IDTypesCRUDPage(WebDriver driver1) {
		super(driver1);
		driver11 = driver1;
	}
	...
	@FindBy(xpath= "//*[@id=\"V0SaveButton\"]") WebElement master_SaveButton;
	
	
	@FindBy(id="IDT_NAME") WebElement latinNameTxt;
