...
public class CountriesCRUDPage extends PageBase {

	public CountriesCRUDPage(WebDriver driver1) {
		super(driver1);
		driver11 = driver1;
	}
	...
	@FindBy(xpath= "//*[@id=\"V1SaveButton\"]") WebElement master_SaveButton;
	
	
	@FindBy(id="COU_LATIN_NAME") WebElement latinNameTxt;
