...
public class ProjectsCRUDPage extends PageBase {

	public ProjectsCRUDPage(WebDriver driver1) {
		super(driver1);
		driver11 = driver1;
	}
	...
	@FindBy(xpath= "//*[@id=\"V4SaveButton\"]") public static WebElement master_SaveButton;
	
	
	@FindBy(id="FCPJ_NAME") WebElement ProjectNametxt;
	@FindBy(id="V4DeleteButton") WebElement deleteBtn;

	//Retrieve All and Paging
	@FindBy(id="V4ResetButton") WebElement retrieveAllBtn;
	@FindBy(id="V4Pagination__NextPage") WebElement nextPageBtn;
	@FindBy(id="V4Pagination__PreviousPage") WebElement previousPageBtn;
	@FindBy(id="V4Pagination__LastPage") WebElement lastPageBtn;
	@FindBy(id="V4Pagination__FirstPage") WebElement firstPageBtn;
	...
	{
		//CRUDMainObject = new CRUDMainPage(driver1);
		CRUDMainObject.updateData(ProjectNametxt, updatenameValue);
	}
	//6- Delete 
