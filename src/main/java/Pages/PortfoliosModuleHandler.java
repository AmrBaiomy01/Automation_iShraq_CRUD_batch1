...
public class PortfoliosModuleHandler extends PageBase {
	
	public PortfoliosModuleHandler(WebDriver driver1) {
		super(driver1);
		driver11 = driver1;
	}
	...
	public static WebElement masterSaveButton;
