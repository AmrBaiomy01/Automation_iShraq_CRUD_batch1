...
public class MonthlyDependOnTransactionWithDDTAndPropertiesFile extends TestBase {
	...
	String PeriodBase="M";
	String ReptDescriptionString= LoadProperties.repaymentName.getProperty("ReptDescriptionString");
